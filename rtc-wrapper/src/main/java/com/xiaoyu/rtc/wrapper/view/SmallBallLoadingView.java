...
public class SmallBallLoadingView extends View {
    ...
    private float MOVE_DISTANCE = 14;
    ...
    public SmallBallLoadingView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    private void initView(Context context) {
        mBitmap = ((BitmapDrawable) context.getResources().getDrawable(R.drawable.blue_ball_small)).getBitmap();
        mBitmap2 = ((BitmapDrawable) context.getResources().getDrawable(R.drawable.orange_ball_small)).getBitmap();
        p = new Paint();
        path = new Path();
    }
